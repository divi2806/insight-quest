...
var ReactiveElement = class extends HTMLElement {
  ...
  __propertyToAttribute(name, value) {
    ...
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a4 = options.converter) == null ? void 0 : _a4.toAttribute) !== void 0 ? options.converter : defaultConverter2;
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      ...
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a4 = options.converter) == null ? void 0 : _a4.fromAttribute) !== void 0 ? options.converter : defaultConverter2;
...
var Pauser = class {
  ...
  resume() {
    var _a4;
    (_a4 = this._resolve) == null ? void 0 : _a4.call(this);
...
var ICONS = {
  add: async () => (await import("./add-CJKAHAFS.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-NA4V3F3T.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-V3ZR6W5R.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-4NUFY23V.js")).appStoreSvg,
  apple: async () => (await import("./apple-3NEN5SHO.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-ZWET5EP7.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-4C7EMNTO.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-U7NDLKSZ.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LVY7KMRA.js")).arrowTopSvg,
  bank: async () => (await import("./bank-FC6KTUMF.js")).bankSvg,
  browser: async () => (await import("./browser-CUR22ILY.js")).browserSvg,
  card: async () => (await import("./card-2NSYGX7P.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-NSFPSHKK.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-AKH7TNUQ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-7NUERDNG.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-PLKKBOMA.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-KROQWXT2.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-QVBRXZOM.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-EX5MHTR2.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-7X7E37VO.js")).clockSvg,
  close: async () => (await import("./close-25CHEORS.js")).closeSvg,
  compass: async () => (await import("./compass-GLIF5523.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-GRJGM3I5.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-DJ4XPLRS.js")).copySvg,
  cursor: async () => (await import("./cursor-PWVZWST2.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-Q7PMM74X.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-F5NCXEW3.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-A5ON6T7M.js")).disconnectSvg,
  discord: async () => (await import("./discord-E5RIBHW5.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-5XFSKXFZ.js")).etherscanSvg,
  extension: async () => (await import("./extension-4EOQOWRN.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-LKPS6N6L.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-TB2MWVM6.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-35O62OY2.js")).farcasterSvg,
  filters: async () => (await import("./filters-GOFUIOKS.js")).filtersSvg,
  github: async () => (await import("./github-KGSSR3UH.js")).githubSvg,
  google: async () => (await import("./google-3GNLQESO.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-W4LG5Y23.js")).helpCircleSvg,
  image: async () => (await import("./image-CNQ6CKBK.js")).imageSvg,
  id: async () => (await import("./id-WOOODGYW.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-3RQQLZGL.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-DCVHM76W.js")).lightbulbSvg,
  mail: async () => (await import("./mail-66JTYFWG.js")).mailSvg,
  mobile: async () => (await import("./mobile-22SVTVSK.js")).mobileSvg,
  more: async () => (await import("./more-TSACVVBU.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-HOUDSPBL.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-HKEZE5AB.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-6QKRZKNZ.js")).offSvg,
  playStore: async () => (await import("./play-store-ZLGMHZPL.js")).playStoreSvg,
  plus: async () => (await import("./plus-3SJ4I52M.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-BHRHXLIF.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-Y6JEUEX6.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-FXVUXB3Y.js")).refreshSvg,
  search: async () => (await import("./search-YMSURXPB.js")).searchSvg,
  send: async () => (await import("./send-MGKUSFQE.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-3VUWK2OW.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-NBR3KSZU.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-XLTJT5FU.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-7OBTZQEK.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-YGWK6KTK.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-KCHSQZMZ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-VZ7LCLKP.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-QPHLNQ7J.js")).twitchSvg,
  twitter: async () => (await import("./x-5TFZBOZP.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-XHMAHXSR.js")).twitterIconSvg,
  verify: async () => (await import("./verify-3YXMPOCH.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-Z7742MIM.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-HVDUMBOV.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-PQBCI3L2.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-PQBCI3L2.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-PQBCI3L2.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-MQMGA7WB.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-RCHWSYLI.js")).warningCircleSvg,
  x: async () => (await import("./x-5TFZBOZP.js")).xSvg,
  info: async () => (await import("./info-ZAG4C5YQ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-HK2JJL3M.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-BJJSS546.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VF7G4VHA.js.map
