...
import { shortenAddress, calculateLevelProgress, getStageEmoji, getStageColor, getRandomAvatarUrl } from "@/lib/web3Utils";
...
const UserProfile = () => {
  ...
  // Use avatarUrl from user object if available, otherwise generate a random one based on address
  const avatarUrl = user.avatarUrl || (address ? getRandomAvatarUrl(address) : undefined);
